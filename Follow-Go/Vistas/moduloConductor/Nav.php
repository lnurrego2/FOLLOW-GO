...
<html lang="es">
    ...
    <body>
        ...
        <header id="topnav">
                ...
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.php" class="logo">
                            <img src="../img/Logo112.png" alt="" height="60" class="logo-small">
                            <img src="../img/Logo112.png" alt="" height="60" class="logo-large">
                        </a>
                    </div>
                    <!-- End Logo container-->
            ...
            <div class="navbar-custom text-xs-center">
                <div class="container-fluid">
                    <div id="navigation">
                        <!-- Navigation Menu-->
                        ...
                        <li class="has-submenu">
                            ...
                            <li class="has-submenu">
                                <a href="formularioSolicitarServicio.php"><i class="fas fa-user"></i>Servicios Activos</a>
                            </li>
                            <li class="has-submenu">
                                <a href="Mostrar_Servicio.php"><i class="fas fa-tasks"></i>Consultar Servicios Disponibles</a>
                            </li>
