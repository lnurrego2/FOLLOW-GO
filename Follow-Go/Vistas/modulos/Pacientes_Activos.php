            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="Reporte_De_Pacientes_Activos.php" method="POST">
                            <div class="form-group">
                                ...
                                -->
                                    <button type="submit" class="btn btn-outline-success" TARGET="_BLANK" name="GenerarReportePacientes">Descargar Reporte</button>
                                    </div>
                            </div>
                        </form>
                    </div>
