...
$body = "Identificación: " .$IdentificacionUsuario. "<br> Nombre: " .$NombreUsuario. "<br> Apellido: " .$ApellidoUsuario. "<br> Correo: " .$CorreoUsuario;
...
try {
    ...
    $mail->Subject = 'Contraseña para ingresar al sistema';
    $mail->Body    = $body;
